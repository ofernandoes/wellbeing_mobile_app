    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(title, style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.textDark)),
            const SizedBox(height: 8),
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(text: '$value'),  
                      TextSpan(text: ' $unit', style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: AppColors.textSubtle)),
                      TextSpan(text: ' (≈${liters.toStringAsFixed(1)}L)', style: TextStyle(fontSize: 16, fontWeight: FontWeight.normal, color: AppColors.textSubtle)),
                    ],
                  ),
                ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('🛐 Gratitude Prompt: What Brightened Your Day?', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.textDark)),
            const SizedBox(height: 8),
            TextField(
